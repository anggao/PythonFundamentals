...
class NewsAgent:
    """
    An object that can distribute news itmes from news 
    ...
    def distribute(self):
        """
        Retrieve all news itmes from all sources, and
...
class NNTPSource:
    """
    A news source that retrieves news itmes from an NNTP group.
    """
...
class SimpleWebSource:
    """
    A news source that extracts news itmes from a web page using regular
    expressions.
    """
...
class PlainDestination:
    """
    A news destination that formats all its news itmes as
    plain text.
    """
